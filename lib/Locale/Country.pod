...
=item country2code ( NAME [,CODESET] )

=item country_code2code ( CODE ,CODESET ,CODESET2 )

=item all_country_codes ( [CODESET] )

=item all_country_names ( [CODESET] )

=item Locale::Country::rename_country  ( CODE ,NEW_NAME [,CODESET] )

=item Locale::Country::add_country  ( CODE ,NAME [,CODESET] )

=item Locale::Country::delete_country  ( CODE [,CODESET] )

=item Locale::Country::add_country_alias  ( NAME ,NEW_NAME )

=item Locale::Country::delete_country_alias  ( NAME )

=item Locale::Country::rename_country_code  ( CODE ,NEW_CODE [,CODESET] )

=item Locale::Country::add_country_code_alias  ( CODE ,NEW_CODE [,CODESET] )

=item Locale::Country::delete_country_code_alias  ( CODE [,CODESET] )
...
=item http://www.iana.org/domains/
