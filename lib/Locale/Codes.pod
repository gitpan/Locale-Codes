...
B<Locale::Codes> is a distribution containing a set of modules.
...
incorporate any changes made in the standards. If one changes, and
...
In a few instances, I may consider an unofficial source. For example,
I get some country data from the CIA World Factbook. Given the nature
of the source, I'm sure they're updating data from the official
sources and I consider it "nearly" official.
...
=item A reliable source of data
...
individual contribution as a reliable source of data. The source must
be an official agency of some sort.
